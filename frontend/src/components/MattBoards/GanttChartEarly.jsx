...
export default function GanttChartEarlyMatt({ boardID, teamID }) {
    ...
    const getGanttData = async () => {
        ...
        try {
            const response = await mattermostApi.post("/gantt/early/", null, {
                params: {
                    board_id: boardID,
                    team_id: teamID
                }
    ...
    return <>
        {loading ? (
            ...
            <div className="flex flex-col mx-auto gap-3">
                <h1 className="font-bold text-xl text-gray-900">Gantt Chart (Early Start / Early Finish)</h1>
