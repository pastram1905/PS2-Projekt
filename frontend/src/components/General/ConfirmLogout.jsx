...
export default function ConfrimLogout() {
    ...
    return (
        <Dialog.Root open={isOpen} onOpenChange={setIsOpen}>
            <Dialog.Trigger asChild>
                <button className="bg-red-400 my-3 p-2 text-[13px] rounded-lg cursor-pointer hover:bg-red-500 transition duration-200"
                >Logout
                </button>
            </Dialog.Trigger>
